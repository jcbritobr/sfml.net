...
namespace SFML.Graphics
{
    ...
    public class VertexArray : ObjectBase, Drawable
    {
        ...
        //////////////////////////////////////////////////////////////
        /// <summary>
        /// Read vertex reference from their index
        ///
        /// This function returns a reference to a unmanaged vertex in
        /// memory.
        /// </summary>
        /// <param name="index"> Index of the vertex to get</param>
        /// <returns>Reference to the index-th vertex</returns>
        //////////////////////////////////////////////////////////////
        public ref Vertex GetVertex(uint index)
        {
            unsafe
            {
                return  ref *sfVertexArray_getVertex(CPointer, index);
            }
        }
